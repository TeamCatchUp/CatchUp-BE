...
public class RagService {
     ...
     */
    public Mono<UserChatResponse> requestChat(String query, UUID sessionId, Long memberId, List<String> indexList) {
     ...
     */
    private Mono<UserChatResponse> processChatRequest(Long memberId, UUID sessionId, String query, List<String> indexList) {
