...
public class SyncEvent {
    ...
    public SyncEvent(Long userId, SyncTarget target, SseEventType type, String simpleMessage) {
        this.userId = userId;
        this.message = SseMessage.simple(target, type, simpleMessage);
    }

    public <T> SyncEvent(Long userId, SyncTarget target, SseEventType type, String messageText, T data) {
        this.userId = userId;
