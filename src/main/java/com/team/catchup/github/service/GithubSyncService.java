...
public class GithubSyncService {
     ...
     */
    @Async
    public void syncRepositoryMetadata(String owner, String repo) {
    ...
    private void publishSimpleMessage(Long userId, SseEventType type, String message) {
        eventPublisher.publishEvent(new SyncEvent(userId, MessageType.SYNC_GITHUB, type, message));
    }

    private void publishProgressMessage(Long userId, SseEventType type, String message,
                                        GithubSyncProgress progress) {
        eventPublisher.publishEvent(
                new SyncEvent(userId, MessageType.SYNC_GITHUB, type, message, progress)
        );
    }
}
